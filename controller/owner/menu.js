const createMenu = require('../../model/owner/menu/createMenu.js');
...
exports.postMenu = async function(req, res, next) {
    ...
    try {
        ...
        await createMenu(food, description, quantity, ingredient, price, category, restaurantName);
    } catch (error) {
        res.send(error);
    }
...
exports.patchMenu = async function(req, res, next) {
    ...
    try {
        ...
        let category = req.body.category;
        let restaurantName = req.params.restaurantName;
        await updateMenu(food, description, quantity, ingredient, price, food, category, restaurantName);
    } catch (error) {
        res.send(error);
    }
